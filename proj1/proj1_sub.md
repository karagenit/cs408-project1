...
EPC: { [0,1,2], [0,2,3], [0,2,4], [0,2,5], [0,2,6],
       ...
       [2,4,7], [2,5,6], [2,6,7], [3,7,8], [3,7,9],
       [4,7,8], [4,7,9], [5,6,7], [6,7,8], [6,7,9],
       [7,8,10], [7,9,10] }

PPC: { [0,1,2,3,7,8,10], [0,1,2,3,7,9,10],
       [0,1,2,4,7,8,10], [0,1,2,4,7,9,10],
       [0,1,2,5,6,7,8,10], [0,1,2,5,6,7,9,10] }       
```
